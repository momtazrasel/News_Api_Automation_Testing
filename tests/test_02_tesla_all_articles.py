...
@allure.step('tesla_all_articles')
def test_o2_tesla_all_articles():
    response_body, status_code = response_get_tesla_all_articles()
    print(response_body)
    ...
    # assert type(response_body["articles"][0]["source"]["id"]) is None
